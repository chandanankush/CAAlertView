...
typedef NS_ENUM(NSInteger, CAAlertViewType) { CAAlertViewTypeDatePicker, CAAlertViewTypeTable };
...
@property(nonatomic, weak, nullable) id<CAAlertViewDelegate> delegate;
